                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6 col-sm-12 pt-1">
                                ...
                                <a href="{{ route('permission') }}" class="btn-icon btn btn-success btn-round"> Data Permission</a>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="font-weight-bold">
                                                @foreach ( $row->getPermissionNames() as $item)
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton6">
                                                    <a class="dropdown-item" href="{{ route('role-permission.edit', $row->id) }}">Edit</a>
