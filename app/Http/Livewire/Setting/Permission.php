...
class Permission extends Component
{
    ...
    public function render()
    {
        ...
        $data = PermissionModel::orderByDesc('created_at')->paginate($this->limitPerPage);
        if($this->search != null){
            $data = PermissionModel::where('name', 'like', '%'.$this->search.'%')->orderByDesc('created_at')->paginate($this->limitPerPage);
        }
    ...
    public function selectAll(){
        if($this->selectAll == true){
            $this->selectRole = PermissionModel::pluck('id');
    ...
    public function deleteConfirmed(){
        PermissionModel::findOrFail($this->selected_id)->delete();
    ...
    public function updatePermission(){
        $save = PermissionModel::findOrFail($this->roleId);
        $save->name = $this->name;
        $save->save();
