...
function setColor(t) {
    (document.getElementById("bootstrap-style").href = "/frontend/assets/css/bootstrap-" + t + ".min.css"), (document.getElementById("app-style").href = "/frontend/assets/css/app-" + t + ".min.css");
}
function setColorGreen() {
    (document.getElementById("bootstrap-style").href = "/frontend/assets/css/bootstrap.min.css"), (document.getElementById("app-style").href = "/frontend/assets/css/app.min.css");
}
